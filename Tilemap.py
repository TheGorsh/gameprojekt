...
class Tilemap(object):
    def __init__(self):
        ...
        self.tileset = Tileset.Tileset("Fabi.jpeg", (255, 0, 255), 32, 32)
        self.tileset.add_tile("grass", 10000, 10000)
        self.tileset.add_tile("mud", 300, 300)
        self.tileset.add_tile("water", 0, 0)
        self.tileset.add_tile("block", 100, 100)
